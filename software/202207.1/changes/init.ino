  ...
  switch (boardID)
  {
   ...
   case 31:
    ...
    case 43:
        ...
        //Pin definitions for Gewitterbox
        //Black F407VE wiki.stm32duino.com/index.php?title=STM32F407
        //https://github.com/oelprinz-org/Gewitterbox
        ...
        // = PA2; //ADC123
        pinO2 = PA3; // O2 Sensor
        pinBaro = PA4; // Baro Sensor
        pinTrigger = PA5; // Crank Sensor
        pinMAP = PA6; // Map Sensor
        pinTPS = PA7; //TPS Sensor
        /////pinCoil3 = PA8;
        ...
        /////pinMAP = PC2; //ADC123 
        pinCLT = PC3; //ADC123
        pinSpareOut1 = PC4; // Spare pin
        pinCLT = PC5;  // Water Temp
        pinTrigger2 = PC6; // Cam Sensor
        pinInjector8 = PC7; // Inj 8
        // = PC8;  //(DO NOT USE FOR SPEEDUINO) - SDIO_D0
        // = PC9;  //(DO NOT USE FOR SPEEDUINO) - SDIO_D1
        // = PC10;  //(DO NOT USE FOR SPEEDUINO) - SDIO_D2
        // = PC11;  //(DO NOT USE FOR SPEEDUINO) - SDIO_D3
        // = PC12;  //(DO NOT USE FOR SPEEDUINO) - SDIO_SCK
        pinFan = PC13; // Cooling Fan 
        // = PC14;  //(DO NOT USE FOR SPEEDUINO) - OSC32_IN
        // = PC15;  //(DO NOT USE FOR SPEEDUINO) - OSC32_OUT
        ...
        pinCoil6 = PD7;  // Ign_6
        // = PD8;  //
        pinInjector1 = PD9;  // Inj_1
        pinInjector2 = PD10;  // Inj_2
        pinInjector3 = PD11;  // Inj_3
        pinInjector4 = PD12;  // Inj_4
        pinTachOut = PD13;  // Tacho_out
        pinFuelPump = PD14; // Fuel_Pump
        pinIdle1 = PD15;  // IdelValve

        //******************************************
        //******** PORTE CONNECTIONS *************** 
        //******************************************
        pinLaunch = PE0; // Launch in
        // = PE1; //
        pinInjector5 = PE2;  // Inj_5
        pinInjector6 = PE3;  // Inj_6
        pinInjector7 = PE4;  // Inj_7
        // = PE5; //
        // = PE6; //
        // = PE7; //
        // = PE8;  //
