  ...
  switch (boardID)
  {
   ...
   case 31:
    ...
    //Pin mappings for all Gewitterbox variants
	  ...
	  pinInjector5 = PE2; // Output pin injector 1
      pinInjector6 = PE3; // Output pin injector 2
      pinInjector7 = PE4; // Output pin injector 3
      pinInjector8 = PC7; // Output pin injector 4
      pinCoil1 = PD5; // Pin for coil 1
      pinCoil2 = PD6; // Pin for coil 2
      pinCoil3 = PB8; // Pin for coil 3
      pinCoil4 = PB9; // Pin for coil 4
	  pinCoil5 = PB6; // Pin for coil 1
      pinCoil6 = PD7; // Pin for coil 2
      pinCoil7 = PD3; // Pin for coil 3
      pinCoil8 = PD4; // Pin for coil 4
      pinTrigger = PA5; // Crank Sensor pin
      pinTrigger2 = PC6; // Cam Sensor pin
      ...
      /////pinStepperEnable = 30; // Enable pin for DRV8825 driver
      pinBoost = PE6; // Boost control
      /////pinSpareLOut1 = 49; // enable Wideband Lambda Heater
      pinFan = PC13; // Pin for fan output
      break;
    #endif
